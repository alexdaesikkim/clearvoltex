...
ActiveRecord::Schema.define(version: 20170421211906) do
  ...
  create_table "dan_stats", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "dan_id"
    t.string   "clear"
    t.string   "score"
  ...
  create_table "dandifficulties", force: :cascade do |t|
    t.integer  "dan_id"
    t.integer  "difficulty_id"
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
  ...
  create_table "dans", force: :cascade do |t|
    t.string   "name"
    t.integer  "level"
