...
class DifficultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create difficulty" do
    assert_difference('Difficulty.count') do
      post difficulties_url, params: { difficulty: { difficulty_name: @difficulty.difficulty_name, level: @difficulty.level, photo: @difficulty.photo, song_id: @difficulty.song_id } }
    end
  ...
  test "should update difficulty" do
    patch difficulty_url(@difficulty), params: { difficulty: { difficulty_name: @difficulty.difficulty_name, level: @difficulty.level, photo: @difficulty.photo, song_id: @difficulty.song_id } }
